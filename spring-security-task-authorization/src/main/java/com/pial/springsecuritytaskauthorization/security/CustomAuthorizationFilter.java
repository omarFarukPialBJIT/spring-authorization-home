...
import com.pial.springsecuritytaskauthorization.repository.UserRepository;
...
//            return null;
            ...
            if (user != null) {
                ...
                String userRole = getUserRoleByUsername(user);
                List<GrantedAuthority> authorities = new ArrayList<>();
                authorities.add(new SimpleGrantedAuthority("ROLE_" + userRole)); // Assuming roles are prefixed with "ROLE_"
